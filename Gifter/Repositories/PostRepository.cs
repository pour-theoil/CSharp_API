...
namespace Gifter.Repositories
{
    public class PostRepository : BaseRepository, IPostRepository
    {
        ...
        public List<Post> Since(DateTime criterion)
        {
            using (var conn = Connection)
            {
                conn.Open();
                ...
                using (var cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"
                          SELECT P.Title, P.Caption, P.DateCreated, P.ImageUrl, P.UserProfileId, 
                                 U.Email, U.Name, U.ImageUrl AS UserProfileImageUrl, 
                                 U.DateCreated AS UserProfileDateCreated
                ...
                using (var cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @"
                          SELECT P.Title, P.Caption, P.DateCreated, P.ImageUrl, P.UserProfileId, 
                            ...
                            FROM Post P  left JOIN UserProfile U ON P.UserProfileId = U.Id
                                 Left Join Comment c on p.Id = c.UserProfileId
